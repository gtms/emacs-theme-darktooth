...
(autothemer-deftheme
 ...
 ((default                                   (:foreground morphine-light0 :background morphine-dark0))
  (cursor                                    (:background morphine-light0))
  (link                                      (:foreground morphine-bright_blue :underline t))
  (link-visited                              (:foreground morphine-bright_blue :underline nil))

  (mode-line                                 (:foreground morphine-light1 :background morphine-dark0_hard :box nil))
  (mode-line-inactive                        (:foreground morphine-light4 :background morphine-dark0 :box t))
  (fringe                                    (:background morphine-dark0))
  (linum                                     (:foreground morphine-dark4))
  ...
  (region                                    (:background morphine-dark_blue :distant-foreground morphine-light0))
  ...
  (minibuffer-prompt                         (:foreground morphine-light0_hard :background morphine-dark0 :bold t))
  ...
  (warning                                   (:foreground morphine-bright_yellow :bold t))
  ...
  (company-echo-common                       (:foreground morphine-bright_blue :background nil))
  (company-preview-common                    (:underline morphine-light1))
  (company-preview                           (:inherit 'company-preview-common))
  (company-preview-search                    (:inherit 'company-preview-common))
  (company-template-field                    (:foreground morphine-bright_blue :background nil :underline morphine-dark_blue))
  (company-scrollbar-fg                      (:foreground nil :background morphine-dark2))
  (company-scrollbar-bg                      (:foreground nil :background morphine-dark3))
  (company-tooltip                           (:foreground morphine-light0_hard :background morphine-dark1))
  (company-preview-common                    (:inherit 'font-lock-comment-face))
  (company-tooltip-common                    (:foreground morphine-light0 :background morphine-dark1))
  (company-tooltip-annotation                (:foreground morphine-bright_blue :background morphine-dark1))
  (company-tooltip-common-selection          (:foreground morphine-light0 :background morphine-faded_blue))
  (company-tooltip-mouse                     (:foreground morphine-dark0 :background morphine-bright_blue))
