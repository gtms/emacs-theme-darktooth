...
(autothemer-deftheme
 ...
 ((default                  (:foreground morphine-light0 :background morphine-dark0))
  ...
  (org-level-1                 (:foreground morphine-neutral_yellow :weight 'bold))
  (org-level-2                 (:foreground morphine-neutral_orange :weight 'bold))
  (org-level-3                 (:foreground morphine-neutral_purple :weight 'bold))
