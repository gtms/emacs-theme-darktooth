...
(autothemer-deftheme
 ...
 ((default                  (:foreground morphine-light0 :background morphine-dark0))
  ...
  (diredfl-autofile-name          (:background morphine-soft_aqua))
  ...
  (diredfl-dir-heading            (:inherit 'header-line))
  ...
  (diredfl-link-priv              (:foreground morphine-soft_green :weight 'bold))
  (diredfl-no-priv                (:foreground morphine-medium))
  (diredfl-number                 (:inherit 'font-lock-keyword-face))
  (diredfl-other-priv             (:foreground morphine-soft_aqua))
  (diredfl-rare-priv              (:foreground morphine-soft_aqua))
  (diredfl-read-priv              (:foreground morphine-soft_aqua))
  (diredfl-symlink                (:foreground morphine-soft_blue :weight 'bold))
  (diredfl-tagged-autofile-name   (:foreground morphine-soft_aqua))
  (diredfl-write-priv             (:foreground morphine-soft_aqua))
  ...
  (which-key-key-face                 (:foreground morphine-faded_yellow :weight 'bold))
  (which-key-separator-face           (:foreground morphine-faded_purple))
  (which-key-note-face                (:foreground morphine-bright_blue :weight 'bold))
  ...
  (which-key-group-description-face   (:foreground morphine-soft_cyan :weight 'bold))
  ...
  (org-verbatim                (:foreground morphine-soft_aqua :background morphine-dark0_soft))
  (org-code                    (:foreground morphine-soft_blue :background morphine-dark0_soft))
  ...
  (company-tooltip-selection            (:foreground morphine-dark_blue :background morphine-darkslategray4 :weight 'bold))
  ...
  (company-tooltip-annotation-selection (:inherit 'company-tooltip-selection :foreground morphine-light2 :slant 'italic :weight 'bold))
  ...
  (ivy-minibuffer-match-face-2    (:background morphine-dark_purple :foreground morphine-bright_purple :weight 'bold))
  ...
  (ivy-modified-outside-buffer    (:foreground morphine-soft_purple))
  (ivy-remote                     (:foreground morphine-faded_green))
  (ivy-virtual                    (:inherit 'font-lock-comment-face))
  (ivy-action                     (:inherit 'font-lock-keyword-face))
  (ivy-highlight-face             (:foreground morphine-soft_cyan :weight 'bold))
  (ivy-prompt-match               (:inherit 'ivy-current-match))
  (ivy-separator                  (:inherit 'font-lock-doc-face))
  (ivy-grep-info                  (:foreground morphine-bright_aqua))
  (ivy-grep-line-number           (:foreground morphine-bright_green))
  (ivy-completions-annotations    (:foreground morphine-dark_blue :background morphine-darkslategray4 :weight 'bold))
  (ivy-yank-word                  (:inherit 'highlight))

  ;; MODE SUPPORT: counsel
  (counsel-outline-default (:foreground morphine-soft_cyan))
  (counsel-outline-1 (:inherit 'org-level-1))
  (counsel-outline-2 (:inherit 'org-level-2))
  (counsel-outline-3 (:inherit 'org-level-3))
  (counsel-outline-4 (:inherit 'org-level-4))
  (counsel-outline-5 (:inherit 'org-level-5))
  ...
  ;; MODE SUPPORT: swiper
  (swiper-match-face-1            (:foreground morphine-medium))
  ...
  (swiper-background-match-face-2 (:background morphine-dark_purple :foreground morphine-faded_purple :weight 'bold))
