...
(autothemer-deftheme
 ...
 ((((class color) (min-colors #xFFFFFF)) ;; color column 1 GUI/24bit
  ...
  (morphine-dark_purple      "#4C3B43" "#5f00af")
  ...
  (morphine-dark_red         "#3F1B1B" "#5f0000")
  ...
  (morphine-dark_orange      "#603000" "#af5f00")
  ...
  (morphine-dark_yellow      "#4C3A25" "#5f5f00")
  ...
  (morphine-dark_green       "#1F321C" "#005f00")
  ...
  (morphine-dark_aqua        "#394C3D" "#005f5f")
  ...
  (morphine-dark_blue        "#30434C" "#00005f")
  ...
  (morphine-dark_cyan        "#005560" "#005f87")
 ...
 ((default                  (:foreground morphine-light0 :background morphine-dark0))
  ...
  (org-table                   (:foreground morphine-turquoise4))
  ...
  ;; (org-verbatim                (:inherit 'shadow :background morphine-dark_aqua))
  ;; (org-verbatim                (:inherit 'shadow :background morphine-dark0_soft))
  ;; (org-verbatim                (:inherit 'shadow :background morphine-dark0_soft :foreground morphine-muted_yellow))
  (org-verbatim                (:inherit 'shadow :background morphine-dark0_soft :foreground morphine-darkslategray4))
  (org-code                (:inherit 'shadow :background morphine-dark0_soft :foreground morphine-aquamarine4))
  ...
  (magit-log-author                          (:foreground morphine-bright_aqua))
