...
(autothemer-deftheme
 ...
 ((default                                   (:foreground darktooth-light0 :background darktooth-dark0))
  ...
  (mode-line-inactive                        (:foreground darktooth-light4 :background darktooth-dark0 :box t))
  ...
  (line-number                               (:foreground darktooth-dark4 :background darktooth-dark0))
  (line-number-current-line                  (:foreground darktooth-dark0 :background darktooth-light4 :weight 'bold))
  (hl-line                                   (:background darktooth-dark0_soft))
  ...
  ;; Built-in syntax
  (font-lock-builtin-face                            (:foreground darktooth-muted_orange :weight 'bold))
  (font-lock-constant-face                           (:foreground darktooth-burlywood4))
  (font-lock-comment-face                            (:foreground darktooth-light4 :slant 'italic))
  (font-lock-function-name-face                      (:foreground darktooth-light4))
  (font-lock-keyword-face                            (:foreground darktooth-sienna :weight 'bold))
  (font-lock-string-face                             (:foreground darktooth-lightblue4))
  ...
  (org-document-title                        (:foreground darktooth-faded_cyan :weight 'bold))
  ...
  (org-level-1                               (:foreground darktooth-bright_orange :weight 'bold))
  (org-level-2                               (:foreground darktooth-bright_green :weight 'bold))
  (org-level-3                               (:foreground darktooth-bright_blue :weight 'bold))
  (org-level-4                               (:foreground darktooth-bright_yellow :weight 'bold))
  (org-level-5                               (:foreground darktooth-faded_aqua :weight 'bold))
  (org-level-6                               (:foreground darktooth-bright_green :weight 'bold))
  (org-level-7                               (:foreground darktooth-bright_red :weight 'bold))
  (org-level-8                               (:foreground darktooth-bright_blue :weight 'bold))
